...
async function capture() {
  console.log("Starting Playwright capture for PRODUCT-VISUAL-REBASE-01...");
  const browser = await chromium.launch({ headless: true });
  const context = await browser.newContext();

  const beats = [
    { name: "scene_02_reference", progress: 0.25, width: 1280, height: 720 },
    { name: "0.15_raw_fragments", progress: 0.3595, width: 1280, height: 720 },
    { name: "0.27_magnetic_assembly", progress: 0.3751, width: 1280, height: 720 },
    { name: "0.35_blueprint_scaffold", progress: 0.3855, width: 1280, height: 720 },
    { name: "0.50_3d_product_core", progress: 0.4050, width: 1280, height: 720 },
    { name: "0.65_full_stack_depth", progress: 0.4245, width: 1280, height: 720 },
    { name: "mobile_390x844", progress: 0.4050, width: 390, height: 844 },
    { name: "reduced_motion", progress: 0.4050, width: 1280, height: 720, reducedMotion: true }
  ];
  ...
  for (const beat of beats) {
    ...
    let url = `http://localhost:5173/?progress=${beat.progress}`;
