...
const beats = [
  { name: "user_story_0.08_idea",         local: 0.08 },
  { name: "user_story_0.22_screens",      local: 0.22 },
  { name: "user_story_0.36_interaction",  local: 0.36 },
  { name: "user_story_0.50_connections",  local: 0.50 },
  { name: "user_story_0.66_content",      local: 0.66 },
  { name: "user_story_0.84_ready",        local: 0.84 },
  { name: "user_story_0.96_handoff",      local: 0.96 },
];

const questions = [
  "What is the active story beat?",
  "Is the label readable?",
  "Did the element build in smoothly?",
  "Did anything pop in suddenly?",
  "Can a non-technical viewer understand it?",
  "Is the HUD separated?",
];

async function capture() {
  console.log("Starting PRODUCT-STORY-USER-05 beat audit captures...");
  ...
  await mPage.screenshot({ path: path.join(targetDir, "user_story_mobile_390x844.png") });
  ...
  await rPage.screenshot({ path: path.join(targetDir, "user_story_reduced_motion.png") });
  ...
  console.log("═══════════════════════════════════════════════════");
  console.log("All PRODUCT-STORY-USER-05 captures complete!");
}
