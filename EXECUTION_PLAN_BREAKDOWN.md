...
_Effort: S · Depends on: nothing (entry point) · Gate: blueprint is single source of truth_
...
_Effort: M · Depends on: Phase 0 locked · Gate: full journey scrollable with placeholders_
...
_Effort: M · Depends on: Phase 1 locked · Gate: full camera journey understandable pre-visuals_
...
_Effort: M · Depends on: Phase 2 locked · Gate: visual quality benchmark for whole portfolio_
...
_Effort: M · Depends on: Phase 3 locked · Gate: identity clear without explanation_
...
_Effort: L · Depends on: Phase 4 locked · Gate: clearly proves full-stack/system thinking_
...
_Effort: L · Depends on: Phase 5 locked · Gate: convinces a recruiter real work exists_
...
_Effort: M · Depends on: Phase 6 locked · Gate: shows product sense without weakening engineer positioning_
...
_Effort: M · Depends on: Phase 7 locked · Gate: justifies the entire device-journey concept_
...
_Effort: L · Depends on: Phase 8 locked · Gate: proves developer isn't frontend-only_
...
_Effort: M · Depends on: Phase 9 locked · Gate: experience ends with clarity and conversion_
...
_Effort: L · Depends on: Phase 10 locked · Gate: feels like one continuous premium product_
...
_Effort: M · Depends on: Phase 11 locked · Gate: all QA checks pass_
...
- **GLTF asset budget.** Recommend deciding poly count and texture resolution ceilings per device _once_, in Phase 0 or 1, rather than re-deciding per scene.
